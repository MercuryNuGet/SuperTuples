...
{
    public sealed class SingleSupleTests : MercurySuite
    {
        protected override void Specifications()
        {
            ...
            Specs += "Equality new Suple<int>(#value)"
               .Arrange()
               .With(new { value = 1 })
               .With(new { value = 2 })
            ...
            Specs += "Equality of hashcode new Suple<int>(#value)"
               .Arrange()
               .With(new { value = 1 })
               .With(new { value = 2 })
